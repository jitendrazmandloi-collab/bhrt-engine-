...
<style>
    ...
    .block-container { padding: 2rem 3rem 4rem 3rem; max-width: 1100px; margin: auto; }
...
<div style="padding: 40px 0 32px 0;">
    ...
    <h1 style="font-size: 2.6rem; font-weight: 700; margin: 8px 0 0 0; letter-spacing: -0.03em; color: #e8e8e8 !important;">
        Identity Stripping
    </h1>
    <p style="color: rgba(255,255,255,0.3) !important; font-size: 14px; margin: 8px 0 0 0; font-weight: 300;">
